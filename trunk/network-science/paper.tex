...
\begin{abstract}
This paper addresses the dynamic properties of typical social networks. We
suppose the evolution over time only includes creating new edges but no
deletion. The paper studies the activity and centrality metrics for nodes in
such graphs by regulating a series of reasonable properties the metrics should
satisfy. Then formal definition is given for our metrics and
also their mathematical analysis. We have developed a practice based framework
...
network data and compare our metric to the static one. The results could imply
