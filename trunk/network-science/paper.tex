...
\begin{abstract}
We address the dynamic properties of typical social networks. We suppose
the evolution over time only includes new connections between existing or newly
created nodes. We study the activity and centrality
...
give their mathematical analysis. We have developed a practice based framework
