...
Suppose $Act(G_t,v)$ returns the activity of node $v$ in the evolving graph in
...
If the network keeps silent, the activity metric of any node $v$ should be decreasing
over time by intuition. Because there is a lower bound for activity and we want
