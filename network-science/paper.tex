...
\begin{center}
	\Large \textbf{\textsf{
		Metrics and Algorithms for Evolving Social Networks}} \\[1.5em]
	\small
		Pufan He\Mark{1}, Yichao Zhou\Mark{2}, Qiwei Feng\Mark{3},
		Yu Yan\Mark{4}, Qingyang Li\Mark{5} and Xin Xing\Mark{6}\\[1em]
	\begin{tabular}{*{3}{>{\centering}p{.25\textwidth}}}
		...
		\href{mailto:gdfqw93@163.com}{gdfqw93@163.com} \tabularnewline
	...
	\normalsize IIIS, Tsinghua University \\[1em]
\end{center} \par
