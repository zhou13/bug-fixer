...
\begin{center} \begin{tikzpicture}
  ...
  \addplot[color=blue!50!black,samples=300,domain=-20:-0.001] {exp(ln(10)*(1/x))}; 
  \addplot[color=green!50!black,samples=300,domain=-20:-0.001] {exp(ln(100)*(1/x))}; 
  \addplot[color=red!50!black,samples=300,domain=-20:-0.001] {exp(ln(1000)*(1/x))}; 
  \end{axis}
\end{tikzpicture}
