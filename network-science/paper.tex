...
returns the evolving activity $a_{\mu,\eta}(G_t,v)$, defined in
Algorithm \ref{alg-act}.
...
optimization, and all execution is done under a typical PC with Intel Core i3.
